...
{
    /// <inheritdoc />
    public partial class DbcreationUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinanceApprover = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Wik = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RatePerKm = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalKilometers = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TotalReimbursement = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    SubmittedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TeamLeadReviewedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TeamLeadComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
